...
// Firebase mit JSON Credentials initialisieren
if (process.env.GOOGLE_APPLICATION_CREDENTIALS_JSON) {
  const serviceAccount = JSON.parse(process.env.GOOGLE_APPLICATION_CREDENTIALS_JSON);
  admin.initializeApp({
    credential: admin.credential.cert(serviceAccount)
  });
  console.log('Firebase erfolgreich initialisiert mit JSON Credentials');
} else {
  console.error('GOOGLE_APPLICATION_CREDENTIALS_JSON nicht gefunden!');
}
